...
f.throttle = function (t, e, i) {
  ...
  i || (i = {});
  var s = function () {
    ((p = i.leading === !1 ? 0 : Date.now()), (a = null), (r = t.apply(n, o)), a || (n = o = null));
  };
  return function () {
    var l = Date.now();
    !p && i.leading !== !1 && (p = l);
    ...
    return (
      ...
      (o = arguments),
      u <= 0 || u > e
        ? (a && (clearTimeout(a), (a = null)), (p = l), (r = t.apply(n, o)), a || (n = o = null))
...
Yt.prototype.getDisplayHtml = function () {
  return this.title;
};
Yt.prototype.beginEdit = function (t) {
  var e = this;
...
Yt.prototype.endEdit = function (t) {
...
Object.defineProperty(Y, "Instance", {
  get: function () {
    var t = Y;
    return t._instance || (t._instance = new Y());
  },
  enumerable: !0,
  configurable: !0,
});
Y.prototype.createEditor = function (t) {
...
A.prototype.multipleSelectByXY = function (t, e) {
  ...
  if (this.startCell) {
    ...
    if (n) {
      var o = ei.mergeRect(this.startCell.cell.getTableRect(), n.cell.getTableRect());
...
A.prototype.selectByRect = function (t, e) {
  ...
  (this.rows.forEach(function (n, o) {
    ...
    (n.columns.forEach(function (a) {
      a.isInRect(t) && (r.push(new ti(o, a)), a.select());
    }),
      r.length && e.push(r));
  }),
...
D.prototype.init = function (t, e, i) {
  ((this.isHead = i),
    (this.target = e || $("<tr></tr>")),
    (this.tableOptions = t),
...
D.prototype.initCells = function (t) {
  var e = this;
  t
...
D.prototype.removeCell = function (t) {
...
Z.prototype.getPrintElementOptionEntity = function () {
  var t = [];
  return (
    this.columns.forEach(function (e) {
      t.push(e.getEntity());
...
ii.prototype.getByIndex = function (t) {
...
st.prototype.css = function (t, e) {
  if (t.find("thead tr").length) {
    if (e === "border") return (t.find("thead tr").css("border", "1px solid"), "border:1pt solid");
    e === "noBorder"
...
mt.prototype.setValue = function (t, e, i) {
  var n = this;
...
mt.prototype.buildData = function () {
  var t = this,
    e = [];
  return (
...
Ht.prototype.css = function (t, e) {
  var i = t.find(".kuprint-printElement-content");
  return (
    i && i.length && (e ? i.css("padding-bottom", e + "pt") : (i[0].style.paddingBottom = "")), null
  );
};
Ht.prototype.createTarget = function () {
  return (
...
Qt.prototype.createTarget = function (t) {
...
Qt.prototype.getValue = function () {
  return (
    (this.isSelect ? this.target.find("select").val() : this.target.find("input").val()) || void 0
  );
};
Qt.prototype.setValue = function (t) {
  this.isSelect
...
te.prototype.setValue = function () {};
...
Mt.prototype.css = function (t, e) {
  if (t && t.length) {
    ...
    (t.removeClass("kuprint-text-content-middle"), t.removeClass("kuprint-text-content-bottom"));
  }
  return null;
};
Mt.prototype.getValue = function () {
...
zt.prototype.setValue = function (t, e) {
...
zt.prototype.loadFormatSelectByDataType = function (t) {
  t === "boolean"
    ? (this.target
...
ke.prototype.createTarget = function () {
  return (
    (this.target = $(
...
var xi = [
  ...
  ze = [].concat(gi, Ti, wi, Pi, xi),
  Oe = {
    init: function () {
      if (!this.printElementOptionItems) {
        this.printElementOptionItems = {};
        for (var t = 0; t < ze.length; t++) this.printElementOptionItems[ze[t].name] = ze[t];
      }
    },
...
g.prototype.design = function (t, e) {
  ...
  (this.designTarget.hidraggable({
    ...
    moveUnit: "pt",
    minMove: _.instance.movingDistance,
    onBeforeDrag: function () {
      ((Q.instance.draging = !0), i.designTarget.focus(), i.createLineOfPosition(e));
    },
    onStopDrag: function () {
      ((Q.instance.draging = !1), i.removeLineOfPosition());
    },
  }),
    this.designTarget.hireizeable({
      showPoints: i.getReizeableShowPoints(),
      onBeforeResize: function () {
        Q.instance.draging = !0;
      },
...
g.prototype.getPrintElementEntity = function (t) {
  return t
    ...
    : new qe(this.printElementType.tid, this.options.getPrintElementOptionEntity(), void 0);
};
...
g.prototype.getFields = function () {
  ...
  return (t || (t = Q.instance.getPrintTemplateById(this.templateId).getFields()), t);
};
  ...
  (t.attr("tabindex", "1"),
    t.keydown(function (n) {
      ...
      switch (n.keyCode) {
        case 37:
          ((o = i.options.getLeft()),
            i.updateSizeAndPositionOptions(o - _.instance.movingDistance),
        ...
        case 38:
          ((r = i.options.getTop()),
            i.updateSizeAndPositionOptions(void 0, r - _.instance.movingDistance),
  ...
  Ii = (function () {
    ...
    return (
      ...
      (t.prototype.resizeTableCellWidth = function () {
        oi.resizeTableCellWeight(this.rows);
      }),
      ...
      (t.prototype.createColumnGrips = function () {
        ...
        (n.width(this.target.width()),
          ...
          (this.cgripContainer = new Je(n, i)));
      }),
      ...
      (t.prototype.createRowGrips = function () {
        ...
        (this.rows.forEach(function (o, r) {
          ...
          this.target.before(n),
          (this.rgripContainer = new Je(n, i)),
          this.syncRowGrips());
      }),
        ...
        if (i.length) {
          ...
          (i.forEach(function (o, r) {
            o.forEach(function (a, p) {
              (r === 0
                ? p !== 0 && ((n.colspan += a.cell.colspan), e.rows[a.rowIndex].removeCell(a.cell))
      ...
      (t.prototype.splitCell = function () {
        ...
        if (e) {
          for (
            var i = e.cell,
              n = this.getCellGrid(),
              o = Ke.getIndex(n[e.rowIndex], i.id),
              r = e.rowIndex;
            r < e.rowIndex + i.rowspan;
            r++
          )
            for (
              var a = this.rows[r], p = r === e.rowIndex ? i : Ke.getLeftTableCell(n[r], o), s = 0;
              s < i.colspan;
              s++
            )
              (r === e.rowIndex && s === 0) ||
        ...
        $(this.handle).hicontextMenu({
          menus: [
            ...
            },
            {
              ...
              callback: function () {
                (e.deleteRow(), e.resizer.updateRowGrips(), f.event.trigger("updateTable" + e.id));
              },
            },
            {
              text: "删除列",
  ...
  ai = (function (t) {
    ...
    function e(i, n) {
      ...
      return (
        ...
        (o.options = new _e(n, o.printElementType)),
        o.options.setDefault(new _e(Le.instance.table.default).getPrintElementOptionEntity()),
        o
      );
    }
    return (
      ...
      (e.prototype.createGridColumnsStructure = function (i) {
        ...
        return new ii(this.options.getGridColumns(), n);
      }),
      ...
      (e.prototype.design = function (i, n) {
        ...
        ($.removeData(this.designTarget[0], "hidraggable"),
          this.designTarget.hidraggable({
            ...
            moveUnit: "pt",
            minMove: Le.instance.movingDistance,
            onBeforeDrag: function () {
...
q.prototype.getTextType = function () {
...
q.prototype.getBarcodeMode = function () {
  return (
...
function Re(t) {
  ...
  return (
    ...
    t.columns
      ? ((e.columns = []),
        t.columns.forEach(function (i) {
          e.columns.push(new Z(i));
        }))
      : (e.columns = [new Z({ columns: [new W({ width: 100 }), new W({ width: 100 })] })]),
    (e.lHeight = t.lHeight),
...
function L(t, e) {
  ...
  return (
    (i.options = new q(e)),
    i.options.setDefault(new q(si.instance.text.default).getPrintElementOptionEntity()),
    i
  );
}
I(L, g);
...
U.prototype.updateTargetHtml = function () {
...
U.prototype.createTarget = function (t, e) {
  var i = $(
...
I(K, g);
K.prototype.updateDesignViewFromOptions = function () {
  this.designTarget && this.css(this.designTarget, this.getData());
};
K.prototype.getConfigOptions = function () {
  return j.instance.hline;
};
K.prototype.createTarget = function () {
  return $(
    '<div class="kuprint-printElement kuprint-printElement-vline" style="border-left:1px solid;position:absolute;"></div>',
  );
};
K.prototype.getReizeableShowPoints = function () {
  return ["s"];
};
K.prototype.getHtml = function (t, e, i) {
  return this.getHtml2(t, e, i);
};
function Vt(t, e) {
  var i = Me.call(this, t) || this;
...
Vt.prototype.getReizeableShowPoints = function () {
  return ["e"];
};
function Nt(t, e) {
  var i = Me.call(this, t) || this;
...
I(At, g);
At.prototype.updateDesignViewFromOptions = function () {
  this.designTarget && this.css(this.designTarget, this.getData());
};
At.prototype.getConfigOptions = function () {
  return j.instance.hline;
};
At.prototype.createTarget = function () {
  return $(
...
var Se = C,
  ...
  Mi = (function (t) {
    ...
    function e(i, n) {
      ...
      return (
        (o.options = new Re(n)),
        o.options.setDefault(new Re(Ve.instance.tableCustom.default).getPrintElementOptionEntity()),
    ...
    return (
      ...
      (e.prototype.getConfigOptions = function () {
        return Ve.instance.tableCustom;
      }),
      (e.prototype.createTarget = function (i, n, o) {
        var r = $(
          '<div class="kuprint-printElement kuprint-printElement-table" style="position:absolute;"><div class="kuprint-printElement-table-handle"></div><div class="kuprint-printElement-table-content" style="height:100%;width:100%"></div></div>',
      ...
      (e.prototype.design = function (i, n) {
        ...
        ($.removeData(this.designTarget[0], "hidraggable"),
          this.designTarget.hidraggable({
            ...
            moveUnit: "pt",
            minMove: Ve.instance.movingDistance,
            onBeforeDrag: function () {
              ((Se.instance.draging = !0), o.createLineOfPosition(n));
            },
            onStopDrag: function () {
              ((Se.instance.draging = !1), o.removeLineOfPosition());
            },
          }),
          this.setHiResizeable(),
          this.designTarget.hireizeable({
            ...
            noContainer: !0,
            onBeforeResize: function () {
              Se.instance.draging = !0;
            },
            onResize: function (r, a, p, s, l) {
              (o.onResize(r, a, p, s, l), o.hitable.updateColumnGrips(), o.createLineOfPosition(n));
            },
            onStopResize: function () {
              ((Se.instance.draging = !1), o.removeLineOfPosition());
            },
...
M.enableDrag = function (t) {
  t.hidraggable({
    revert: !0,
    proxy: function (e) {
      var i = J.instance.getDragingPrintElement(),
    ...
    onDrag: function (e, i, n) {
      J.instance.getDragingPrintElement().updatePosition(i, n);
    },
    onStopDrag: function () {
      J.instance.draging = !1;
    },
  });
};
...
var Ni = (function () {
  ...
  Be = function (t) {
    if (((this.index = t.index), (this.paperType = t.paperType), this.paperType)) {
      var e = J.instance[this.paperType];
      t.height
      ...
      (t.prototype.createPaperNumber = function (e) {
        ...
        return (
          ...
          this.dragHeadLineOrFootLine(
            o,
            function (r, a) {
              ((i.paperNumberTop = a), (i.paperNumberLeft = r), i.triggerOnPaperBaseInfoChanged());
            },
            !0,
          ),
          o
  ...
  Ne = function (t) {
    if (t)
      if (t.panels) {
        this.panels = [];
        for (var e = 0; e < t.panels.length; e++) this.panels.push(new Be(t.panels[e]));
      } else this.panels = [];
  },
  Wi = (function () {
    function t(e, i) {
...
function F(t, e) {
  ...
  return (
    (i.options = new Fe(e)),
    i.options.setDefault(new Fe(ci.instance.longText.default).getPrintElementOptionEntity()),
    i
  );
}
I(F, g);
F.prototype.getDesignTarget = function (t) {
  ...
  return (e.find(".kuprint-printElement-longText-content").css("border", "1px dashed #cebcbc"), e);
};
    ...
    return (
      ...
      (t.prototype.droppablePaper = function (e) {
        ...
        e.getTarget().hidroppable({
          ...
          onDrop: function () {
            var n = X.instance.getDragingPrintElement(),
              o = n.printElement;
        ...
        ((this.printElements = []),
          e &&
            e.forEach(function (n) {
              ...
              if (
                (n.printElementType
                  ? (o = De.createPrintElementType(n.printElementType))
                  : (o = Gt.instance.getElementType(n.tid)),
                o)
              ) {
      ...
      (t.prototype.mathroundToporleft = function (e) {
        var i = R.instance.movingDistance;
      ...
      (t.prototype.getPrintElementTypeByEntity = function (e) {
        ...
        return (
          e.tid
            ? (i = Gt.instance.getElementType(e.tid))
            : (i = De.createPrintElementType(e.printElementType)),
            ...
            X.instance.draging ||
              ...
              i.buttons === 1 &&
                (e.mouseRect = new Ai(
                  i.pageX,
                  i.pageY,
                  X.instance.dragLengthCNum(
                    i.pageX - e.designPaper.getTarget().offset().left,
                    R.instance.movingDistance,
                  ),
                  X.instance.dragLengthCNum(
      ...
      (t.prototype.bingKeyboardMoveEvent = function (e) {
        ...
        (e.attr("tabindex", "1"),
          e.keydown(function (n) {
            ...
            switch (n.keyCode) {
              case 37:
                (i.mouseRect.updatePositionByMultipleSelect(-R.instance.movingDistance, 0),
                  o.forEach(function (r) {
                    r.updatePositionByMultipleSelect(-R.instance.movingDistance, 0);
                  }),
                  n.preventDefault());
                break;
              case 38:
                (i.mouseRect.updatePositionByMultipleSelect(0, -R.instance.movingDistance),
                  o.forEach(function (r) {
                    r.updatePositionByMultipleSelect(0, -R.instance.movingDistance);
                  }),
                  n.preventDefault());
                break;
              case 39:
    ...
    t &&
      ...
      t.templates.forEach(function (i) {
        ...
        (t.imgToBase64 && (n.imgToBase64 = !0),
          e ? e.append(i.template.getHtml(i.data, n).html()) : (e = i.template.getHtml(i.data, n)));
      }),
    e
  );
}
function Ui(t) {
  (R.instance.init(t),
    R.instance.providers.forEach(function (e) {
  ...
  Ki = (function () {
    function t(e) {
      ...
      ((this.tempImageBase64 = {}),
        (this.id = Wt.instance.guid()),
        Wt.instance.setPrintTemplateById(this.id, this));
      var n = e || {};
      this.printPanels = [];
      var o = new Ne(n.template || []);
      (n.template &&
        o.panels.forEach(function (r) {
          i.printPanels.push(new Ae(r, i.id));
        }),
    ...
    return (
      ...
      (t.prototype.addPrintPanel = function (e, i) {
        var n = e ? new Ae(new Be(e), this.id) : this.createDefaultPanel();
        return (
...
(function (t) {
  ...
  function i(a) {
    ...
    (l || (l = t(a.data.target)),
      l.css({
        left: t.fn.dragLengthC(a.data.left, s),
        top: t.fn.dragLengthC(a.data.top, s),
      }),
    ...
    if (l.revert)
      if (c() === 1)
        ...
        (s.parent()[0] === document.body
          ? ((u = a.data.startX - a.data.offsetWidth), (h = a.data.startY - a.data.offsetHeight))
  ...
  ((t.fn.hidraggable = function (a, p) {
    return typeof a == "string"
      ...
      : this.each(function () {
          ...
          var u = l.handle ? (typeof l.handle == "string" ? t(l.handle, this) : l.handle) : t(this);
          function h(d) {
  ...
  ((e.prototype = {
    init: function (i, n) {
      ((this.ele = i),
        ...
        (this.random = /* @__PURE__ */ new Date().getTime() + parseInt(1e3 * Math.random())),
        this.eventBind());
    },
        ...
        (r || (r = a.addClass("hicontextmenuroot")),
          t.each(i, function (p, s) {
            ...
            (l && u.addClass("disable"),
              ...
              s.callback &&
                u.click(function (h) {
                  (t(this).hasClass("disable") || (t(".hicontextmenuroot").remove(), s.callback()),
                    h.stopPropagation());
                }),
              a.append(u));
          }),
...
window.hiwebSocket = /* @__PURE__ */ (function () {
  var t = "connected",
    e = "reconnecting";
  return {
    opened: !1,
