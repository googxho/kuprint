...
var TableColumnOptionEntity = function (opts) {
  ...
  this.columnId = opts.columnId;
  this.fixed = false;
  this.rowspan = opts.rowspan || 1;
  this.colspan = opts.colspan || 1;
  this.align = opts.align;
  this.halign = opts.halign;
  this.vAlign = opts.vAlign;
  this.formatter2 = opts.formatter2;
  this.styler2 = opts.styler2;
};
...
var TablePrintElementOption = (function (_super) {
  ...
  TablePrintElementOption.prototype.getGridColumns = function () {
    ...
    if (this.columns) {
      ...
      this.columns.forEach(function (layer) {
        var cols = layer
          ...
          .map(function (c) {
            return new TableColumnOptionEntity(c);
          });
...
var TablePrintElement = (function (_super) {
  ...
  TablePrintElement.prototype.getTableHtml = function (data, templateData) {
    ...
    table.append(
      TableExcelHelper.createTableRow(this.getColumns(), data, this.options, this.printElementType),
    );
  ...
  TablePrintElement.prototype.getRowsInSpecificHeight = function (
    ...
    if (gridFooterFn) {
      emptyTarget
        ...
        .html(gridFooterFn(this.options, this.getData(templateData), templateData, allRows));
    }
    if (sourceTbody.find("tr").length === 0) {
  ...
  TablePrintElement.prototype.onResize = function (e, h, w, t, l) {
    ...
    TableExcelHelper.resizeTableCellWidth(
      this.designTarget,
      this.getColumns(),
  ...
  TablePrintElement.prototype.getFooterFormatter = function () {
    ...
    if (this.options.footerFormatter) {
      try {
        fn = new Function("return (" + this.options.footerFormatter + ")")();
      } catch (e) {
        console.log(e);
      }
    }
  ...
  TablePrintElement.prototype.getGridColumnsFooterFormatter = function () {
    ...
    if (this.printElementType.gridColumnsFooterFormatter)
      fn = this.printElementType.gridColumnsFooterFormatter;
    if (this.options.gridColumnsFooterFormatter) {
      try {
        fn = new Function("return (" + this.options.gridColumnsFooterFormatter + ")")();
      } catch (e) {
        console.log(e);
      }
    }
...
export { TablePrintElementOption, TablePrintElement };
