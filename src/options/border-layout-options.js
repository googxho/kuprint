...
(function() {
    ...
    BorderWidthOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("border-width", value + "pt"); return "border-width:" + value + "pt"; }
    ...
    BorderWidthOption.prototype.destroy = function () { this.target.remove(); };
    ...
    BorderColorOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("border-color", value); return "border-color:" + value; }
    ...
    BorderColorOption.prototype.destroy = function () { this.target.remove(); };
    ...
    BorderTopOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("border-top-style", value); target.css("border-top-width", "1px"); }
            else { target[0].style.borderTopStyle = ""; target[0].style.borderTopWidth = ""; }
        }
        return null;
    };
    ...
    BorderTopOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    BorderTopOption.prototype.destroy = function () { this.target.remove(); };
    ...
    BorderLeftOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("border-left-style", value); target.css("border-left-width", "1px"); }
            else { target[0].style.borderLeftStyle = ""; target[0].style.borderLeftWidth = ""; }
        }
        return null;
    };
    ...
    BorderLeftOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    BorderLeftOption.prototype.destroy = function () { this.target.remove(); };
    ...
    BorderRightOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("border-right-style", value); target.css("border-right-width", "1px"); }
            else { target[0].style.borderRightStyle = ""; target[0].style.borderRightWidth = ""; }
        }
        return null;
    };
    ...
    BorderRightOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    BorderRightOption.prototype.destroy = function () { this.target.remove(); };
    ...
    BorderBottomOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("border-bottom-style", value); target.css("border-bottom-width", "1px"); }
            else { target[0].style.borderBottomStyle = ""; target[0].style.borderBottomWidth = ""; }
        }
        return null;
    };
    ...
    BorderBottomOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    BorderBottomOption.prototype.destroy = function () { this.target.remove(); };
    ...
    ContentPaddingTopOption.prototype.css = function (target, value) {
        ...
        if (content && content.length) {
            if (value) { content.css("padding-top", value + "pt"); }
            else { content[0].style.paddingTop = ""; }
        }
        return null;
    };
    ...
    ContentPaddingTopOption.prototype.destroy = function () { this.target.remove(); };
    ...
    ContentPaddingLeftOption.prototype.css = function (target, value) {
        var content = target.find(".kuprint-printElement-content");
        if (content && content.length) {
            if (value) { content.css("padding-left", value + "pt"); }
            else { content[0].style.paddingLeft = ""; }
        }
        return null;
    };
    ...
    ContentPaddingLeftOption.prototype.destroy = function () { this.target.remove(); };
    ...
    ContentPaddingRightOption.prototype.css = function (target, value) {
        var content = target.find(".kuprint-printElement-content");
        if (content && content.length) {
            if (value) { content.css("padding-right", value + "pt"); }
            else { content[0].style.paddingRight = ""; }
        }
        return null;
    };
    ...
    ContentPaddingRightOption.prototype.destroy = function () { this.target.remove(); };
    ...
    ContentPaddingBottomOption.prototype.css = function (target, value) {
        var content = target.find(".kuprint-printElement-content");
        if (content && content.length) {
            if (value) { content.css("padding-bottom", value + "pt"); }
            else { content[0].style.paddingBottom = ""; }
        }
        return null;
    };
    ...
    ContentPaddingBottomOption.prototype.destroy = function () { this.target.remove(); };
    ...
    BorderStyleOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("border-style", value); }
            else { target[0].style.borderStyle = ""; }
        }
        return null;
    };
    ...
    BorderStyleOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    BorderStyleOption.prototype.destroy = function () { this.target.remove(); };
    ...
    PaddingLeftOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("padding-left", value + "pt"); return "padding-left"; }
    ...
    PaddingLeftOption.prototype.destroy = function () { this.target.remove(); };
    ...
    PaddingRightOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("padding-right", value + "pt"); return "padding-right"; }
    ...
    PaddingRightOption.prototype.destroy = function () { this.target.remove(); };
