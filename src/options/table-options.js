...
(function() {
    ...
    TableBorderOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    TableBorderOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableHeaderBorderOption.prototype.css = function (target, value) {
        if (target.find("thead tr").length) {
            ...
            if (value === "noBorder") {
                ...
                target.find("thead tr").each(function (i, el) { el.style.border = ""; });
            }
        }
        return null;
    };
    ...
    TableHeaderBorderOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    TableHeaderBorderOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableHeaderCellBorderOption.prototype.css = function (target, value) {
        if (target.find("thead tr td").length) {
            ...
            if (value === "noBorder") {
                ...
                target.find("thead tr td").each(function (i, el) { el.style.border = ""; });
            }
        }
        return null;
    };
    ...
    TableHeaderCellBorderOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    TableHeaderCellBorderOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableHeaderRowHeightOption.prototype.css = function (target, value) {
        if (target.find("thead tr td").length) {
            if (value) {
                ...
                target.find("thead tr td").each(function (i, el) { el.style.height = ""; });
            }
        }
        return null;
    };
    ...
    TableHeaderRowHeightOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableHeaderFontSizeOption.prototype.css = function (target, value) {
        if (target.find("thead").length) {
            if (value) {
                ...
                target.find("thead").each(function (i, el) { el.style.fontSize = ""; });
            }
        }
        return null;
    };
    ...
    TableHeaderFontSizeOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableHeaderFontWeightOption.prototype.css = function (target, value) {
        if (target.find("thead").length) {
            if (value) {
                ...
                target.find("thead tr td").each(function (i, el) { el.style.fontWeight = ""; });
            }
        }
        return null;
    };
    ...
    TableHeaderFontWeightOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableBodyCellBorderOption.prototype.css = function (target, value) {
        if (target.find("tbody tr td").length) {
            ...
            if (value === "noBorder") {
                ...
                target.find("tbody tr td").each(function (i, el) { el.style.border = ""; });
            }
        }
        return null;
    };
    ...
    TableBodyCellBorderOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    TableBodyCellBorderOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableBodyRowHeightOption.prototype.css = function (target, value) {
        if (target.find("tbody tr td").length) {
            if (value) {
                ...
                target.find("tbody tr td").each(function (i, el) { el.style.height = ""; });
            }
        }
        return null;
    };
    ...
    TableBodyRowHeightOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableHeaderBackgroundOption.prototype.css = function (target, value) {
        if (target.find("thead").length) {
            if (value) {
                ...
                target.find("thead").each(function (i, el) { el.style.backgroundColor = ""; });
            }
        }
        return null;
    };
    ...
    TableHeaderBackgroundOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableBodyRowBorderOption.prototype.css = function (target, value) {
        if (target.find("tbody tr").length) {
            if (value === "border") {
                ...
                target.find("tbody tr").each(function (i, el) { el.style.border = ""; });
            }
        }
        return null;
    };
    ...
    TableBodyRowBorderOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    TableBodyRowBorderOption.prototype.destroy = function () { this.target.remove(); };
    ...
    ColumnsOption.prototype.getValue = function () { return this.buildData(); };
    ColumnsOption.prototype.setValue = function (value, options, printElementType) {
        var self = this;
        this.value = value;
        this.options = options;
        this.printElementType = printElementType;
        var unselected = printElementType.columns[0].filter(function (col) {
            return value[0].columns.filter(function (vc) { return col.columnId === vc.columnId; }).length === 0;
        }).map(function (col) {
        ...
        if (value && value.length === 1) {
            this.target.find("ul").html(this.allColumns.map(function (col) {
                return '<li class="kuprint-option-table-selected-item">' +
                    '<div class="hi-pretty p-default">' +
                    (col.checked ? '<input type="checkbox" checked column-id="' + (col.columnId || "") + '" />' :
                        '<input type="checkbox" column-id="' + (col.columnId || "") + '" />') +
                    '<div class="state"><label></label></div></div>' +
                    '<span class="column-title">' + (col.title || col.descTitle || "") + '</span></li>';
            }).join(""));
            this.target.find("input").change(function () { self.submit(); });
            if (this.printElementType.columnDisplayIndexEditable) {
                this.target.find("li").hidraggable({
                    ...
                    onDragOver: function () { $(this).css("border-bottom-color", "red"); },
                    onDragLeave: function () { $(this).css("border-bottom-color", ""); },
    ...
    ColumnsOption.prototype.buildData = function () {
        var self = this;
        var result = [];
        this.allColumns.forEach(function (col) { col.checked = false; });
        var inputs = this.printElementType.columnDisplayEditable
            ? this.target.find("input:checked") : this.target.find("input");
    ...
    ColumnsOption.prototype.destroy = function () { this.target.remove(); };
    ...
    GridColumnsOption.prototype.destroy = function () { this.target.remove(); };
    ...
    GridColumnsGutterOption.prototype.css = function (target, value) {
        if (target && target.length) {
            ...
            target.find(".table-grid-row").each(function (i, el) { el.style.marginLeft = ""; el.style.marginRight = ""; });
            target.find(".tableGridColumnsGutterRow").each(function (i, el) { el.style.paddingLeft = ""; el.style.paddingRight = ""; });
        }
        return null;
    };
    ...
    GridColumnsGutterOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TableFooterRepeatOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    TableFooterRepeatOption.prototype.destroy = function () { this.target.remove(); };
