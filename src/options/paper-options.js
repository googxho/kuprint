...
PaperNumberFormatOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
PaperNumberFormatOption.prototype.destroy = function () {
  this.target.remove();
};
...
PaperNumberDisabledOption.prototype.setValue = function (v) {
  this.target.find("select").val(v);
};
PaperNumberDisabledOption.prototype.destroy = function () {
  this.target.remove();
};
...
LongTextIndentOption.prototype.destroy = function () {
  this.target.remove();
};
...
ShowInPageOption.prototype.setValue = function (v) {
  this.target.find("select").val(v);
};
ShowInPageOption.prototype.destroy = function () {
  this.target.remove();
};
...
PanelPaperRuleOption.prototype.setValue = function (v) {
  this.target.find("select").val(v);
};
PanelPaperRuleOption.prototype.destroy = function () {
  this.target.remove();
};
...
LeftSpaceRemovedOption.prototype.destroy = function () {
  this.target.remove();
};
...
FirstPaperFooterOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
FirstPaperFooterOption.prototype.destroy = function () {
  this.target.remove();
};
...
LastPaperFooterOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
LastPaperFooterOption.prototype.destroy = function () {
  this.target.remove();
};
...
EvenPaperFooterOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
EvenPaperFooterOption.prototype.destroy = function () {
  this.target.remove();
};
...
OddPaperFooterOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
OddPaperFooterOption.prototype.destroy = function () {
  this.target.remove();
};
...
FixedOption.prototype.destroy = function () {
  this.target.remove();
};
...
AxisOption.prototype.setValue = function (v) {
  this.target.find("select").val(v);
};
AxisOption.prototype.destroy = function () {
  this.target.remove();
};
...
TopOffsetOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
TopOffsetOption.prototype.destroy = function () {
  this.target.remove();
};
...
LeftOffsetOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
LeftOffsetOption.prototype.destroy = function () {
  this.target.remove();
};
...
LHeightOption.prototype.setValue = function (v) {
  this.target.find("input").val(v);
};
LHeightOption.prototype.destroy = function () {
  this.target.remove();
};
...
UnShowInPageOption.prototype.setValue = function (v) {
  this.target.find("select").val(v);
};
UnShowInPageOption.prototype.destroy = function () {
  this.target.remove();
};
