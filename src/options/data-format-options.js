...
(function() {
    ...
    BarcodeModeOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    BarcodeModeOption.prototype.destroy = function () { this.target.remove(); };
    ...
    ColorOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("color", value); return "color:" + value; }
    ...
    ColorOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TextDecorationOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("text-decoration", value); return "text-decoration:" + value; }
    ...
    TextDecorationOption.prototype.destroy = function () { this.target.remove(); };
    ...
    FieldOption.prototype.createTarget = function (printElement) {
        ...
        if (fields) {
            this.isSelect = true;
            var html = '<div class="kuprint-option-item kuprint-option-item-row">' +
    ...
    FieldOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TitleOption.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    TitleOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TestDataOption.prototype.setValue = function (v) { this.target.find("input").val(v); };
    TestDataOption.prototype.destroy = function () { this.target.remove(); };
    ...
    SrcOption.prototype.setValue = function (v) { this.target.find("input").val(v); };
    SrcOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TransformOption.prototype.setValue = function (v) { this.target.find("input").val(v); };
    TransformOption.prototype.destroy = function () { this.target.remove(); };
    ...
    OptionsGroupOption.prototype.destroy = function () { this.target.remove(); };
    ...
    BackgroundColorOption.prototype.css = function (target, value) {
        if (target && target.length) {
            if (value) { target.css("background-color", value); }
            else { target[0].style.backgroundColor = ""; }
        }
        return null;
    };
    ...
    BackgroundColorOption.prototype.destroy = function () { this.target.remove(); };
    ...
    OrientOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    OrientOption.prototype.destroy = function () { this.target.remove(); };
    ...
    TextContentVerticalAlignOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    TextContentVerticalAlignOption.prototype.destroy = function () { this.target.remove(); };
    ...
    DataTypeOption.prototype.createTarget = function () {
        var self = this;
        this.target = $('<div class="kuprint-option-item-row">' +
    ...
    DataTypeOption.prototype.destroy = function () { this.target.remove(); };
    DataTypeOption.prototype.loadFormatSelectByDataType = function (dtype) {
        if (dtype === "boolean") {
            this.target.find(".kuprint-option-item-datatype-select-format")
                .removeClass("kuprint-option-item-datatype-format").hide().val("");
            this.target.find(".kuprint-option-item-datatype-input-format")
                .addClass("kuprint-option-item-datatype-format").show();
        } else if (dtype === "datetime") {
            this.target.find(".kuprint-option-item-datatype-select-format")
                .addClass("kuprint-option-item-datatype-format").show();
            this.target.find(".kuprint-option-item-datatype-input-format")
                .removeClass("kuprint-option-item-datatype-format").hide().val("");
            this.target.find(".kuprint-option-item-datatype-select-format").html(
                '<option value="">默认</option>' +
    ...
    FormatterOption.prototype.createTarget = function () {
        this.target = $('<div class="kuprint-option-item kuprint-option-item-row">' +
            ...
            '<div class="kuprint-option-item-field">' +
            '<textarea style="height:80px;" placeholder="' + (this.placeholder || "") + '" class="auto-submit"></textarea></div></div>');
        return this.target;
    };
    FormatterOption.prototype.getValue = function () { return this.target.find("textarea").val() || undefined; };
    FormatterOption.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    FormatterOption.prototype.destroy = function () { this.target.remove(); };
    ...
    StylerOption.prototype.getValue = function () { return this.target.find("textarea").val() || undefined; };
    StylerOption.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    StylerOption.prototype.destroy = function () { this.target.remove(); };
    ...
    FooterFormatterOption.prototype.getValue = function () { return this.target.find("textarea").val() || undefined; };
    FooterFormatterOption.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    FooterFormatterOption.prototype.destroy = function () { this.target.remove(); };
    ...
    GridColumnsFooterFormatterOption.prototype.getValue = function () { return this.target.find("textarea").val() || undefined; };
    GridColumnsFooterFormatterOption.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    GridColumnsFooterFormatterOption.prototype.destroy = function () { this.target.remove(); };
    ...
    RowStylerOption.prototype.getValue = function () { return this.target.find("textarea").val() || undefined; };
    RowStylerOption.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    RowStylerOption.prototype.destroy = function () { this.target.remove(); };
    ...
    AlignOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    AlignOption.prototype.destroy = function () { this.target.remove(); };
    ...
    VAlignOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    VAlignOption.prototype.destroy = function () { this.target.remove(); };
    ...
    HAlignOption.prototype.setValue = function (v) { this.target.find("select").val(v); };
    HAlignOption.prototype.destroy = function () { this.target.remove(); };
    ...
    Styler2Option.prototype.getValue = function () { return this.target.find("textarea").val() || undefined; };
    Styler2Option.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    Styler2Option.prototype.destroy = function () { this.target.remove(); };
    ...
    Formatter2Option.prototype.getValue = function () { return this.target.find("textarea").val() || undefined; };
    Formatter2Option.prototype.setValue = function (v) { this.target.find("textarea").val(v); };
    Formatter2Option.prototype.destroy = function () { this.target.remove(); };
    ...
    AutoCompletionOption.prototype.destroy = function () { this.target.remove(); };
