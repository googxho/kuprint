...
LineHeightOption.prototype.destroy = function () {
  this.target.remove();
};
...
FontFamilyOption.prototype.destroy = function () {
  this.target.remove();
};
...
FontWeightOption.prototype.destroy = function () {
  this.target.remove();
};
...
LetterSpacingOption.prototype.css = function (target, value) {
  if (target && target.length) {
    if (value) {
      target.css("letter-spacing", value + "pt");
...
LetterSpacingOption.prototype.destroy = function () {
  this.target.remove();
};
...
TextAlignOption.prototype.setValue = function (v) {
  this.target.find("select").val(v);
};
TextAlignOption.prototype.destroy = function () {
  this.target.remove();
};
...
HideTitleOption.prototype.destroy = function () {
  this.target.remove();
};
...
TextTypeOption.prototype.setValue = function (v) {
  this.target.find("select").val(v);
};
TextTypeOption.prototype.destroy = function () {
  this.target.remove();
};
