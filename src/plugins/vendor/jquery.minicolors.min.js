...
!(function (i) {
  ...
  function t(t, o) {
    var s,
      ...
      l,
      h,
      d = i('<div class="minicolors" />'),
      p = i.minicolors.defaults;
    if (!t.data("minicolors-initialized")) {
      if (
        ((o = i.extend(!0, {}, p, o)),
        d.addClass("minicolors-theme-" + o.theme).toggleClass("minicolors-with-opacity", o.opacity),
        void 0 !== o.position &&
          i.each(o.position.split(" "), function () {
            d.addClass("minicolors-position-" + this);
          }),
        (a = "rgb" === o.format ? (o.opacity ? "25" : "20") : o.keywords ? "11" : "7"),
        t
          .addClass("minicolors-input")
          .data("minicolors-initialized", !1)
          .data("minicolors-settings", o)
          .prop("size", a)
          .wrap(d)
          .after(
        ...
        (l = t.parent().find(".minicolors-panel")),
        l
        ...
        for (
          l.addClass("minicolors-with-swatches"),
            n = i('<ul class="minicolors-swatches"></ul>').appendTo(l),
            h = 0;
          h < o.swatches.length;
          ++h
        )
          ("object" === i.type(o.swatches[h])
            ? ((s = o.swatches[h].name), (e = o.swatches[h].color))
            : ((s = ""), (e = o.swatches[h])),
            (r = e),
            (e = v(e) ? g(e, !0) : I(u(e, !0))),
            i(
              '<li class="minicolors-swatch minicolors-sprite"><span class="minicolors-swatch-color" title="' +
                s +
                '"></span></li>',
            )
              .appendTo(n)
              ...
              .css({ backgroundColor: C(e), opacity: e.a }),
            (o.swatches[h] = e));
  ...
  function a() {
    i(".minicolors-focus").each(function () {
      ...
      s.animate
        ...
        : (s.hide(), a.hide && a.hide.call(o.get(0)), t.removeClass("minicolors-focus"));
    });
  }
  function n(i, t, o) {
    var s,
      ...
      r,
      c,
      l = i.parents(".minicolors").find(".minicolors-input"),
      h = l.data("minicolors-settings"),
      d = i.find("[class$=-picker]"),
      p = i.offset().left,
      u = i.offset().top,
      g = Math.round(t.pageX - p),
      m = Math.round(t.pageY - u),
      f = o ? h.animationSpeed : 0;
    (t.originalEvent.changedTouches &&
      ((g = t.originalEvent.changedTouches[0].pageX - p),
      (m = t.originalEvent.changedTouches[0].pageY - u)),
      g < 0 && (g = 0),
      m < 0 && (m = 0),
      g > i.width() && (g = i.width()),
      m > i.height() && (m = i.height()),
      i.parent().is(".minicolors-slider-wheel") &&
        d.parent().is(".minicolors-grid") &&
        ((s = 75 - g),
        (a = 75 - m),
        (n = Math.sqrt(s * s + a * a)),
        (r = Math.atan2(a, s)),
        r < 0 && (r += 2 * Math.PI),
        n > 75 && ((n = 75), (g = 75 - 75 * Math.cos(r)), (m = 75 - 75 * Math.sin(r))),
        (g = Math.round(g)),
        (m = Math.round(m))),
      (c = { top: m + "px" }),
      i.is(".minicolors-grid") && (c.left = g + "px"),
      d.animate
        ? d.stop(!0).animate(c, f, h.animationEasing, function () {
            e(l, i);
          })
        : (d.css(c), e(l, i)));
  }
      ...
      switch (m.control) {
        case "wheel":
          ((e = b.width() / 2 - I.x),
            ...
            (d = Math.atan2(c, e)),
            d < 0 && (d += 2 * Math.PI),
            h > 75 && ((h = 75), (I.x = 69 - 75 * Math.cos(d)), (I.y = 69 - 75 * Math.sin(d))),
            (a = f(h / 0.75, 0, 100)),
            (s = f((180 * d) / Math.PI, 0, 360)),
            (n = f(100 - Math.floor(S.y * (100 / w.height())), 0, 100)),
            (p = k({ h: s, s: a, b: n })),
            w.css("backgroundColor", k({ h: s, s: a, b: 100 })));
          break;
        case "saturation":
          ((s = f(parseInt(I.x * (360 / b.width()), 10), 0, 360)),
            (a = f(100 - Math.floor(S.y * (100 / w.height())), 0, 100)),
            (n = f(100 - Math.floor(I.y * (100 / b.height())), 0, 100)),
            (p = k({ h: s, s: a, b: n })),
            w.css("backgroundColor", k({ h: s, s: 100, b: n })),
            g.find(".minicolors-grid-inner").css("opacity", a / 100));
          break;
        case "brightness":
          ((s = f(parseInt(I.x * (360 / b.width()), 10), 0, 360)),
            (a = f(100 - Math.floor(I.y * (100 / b.height())), 0, 100)),
            (n = f(100 - Math.floor(S.y * (100 / w.height())), 0, 100)),
            (p = k({ h: s, s: a, b: n })),
            w.css("backgroundColor", k({ h: s, s: a, b: 100 })),
          ...
          break;
        default:
          ((s = f(360 - parseInt(S.y * (360 / w.height()), 10), 0, 360)),
            (a = f(Math.floor(I.x * (100 / b.width())), 0, 100)),
            (n = f(100 - Math.floor(I.y * (100 / b.height())), 0, 100)),
            (p = k({ h: s, s: a, b: n })),
            b.css("backgroundColor", k({ h: s, s: 100, b: 100 })));
      }
      ((u = m.opacity ? parseFloat(1 - z.y / y.height()).toFixed(2) : 1), r(i, p, u));
    } else (v.find("span").css({ backgroundColor: p, opacity: u }), l(i, p, u));
  }
  function r(i, t, o) {
    var s,
      a = i.parent(),
  ...
  function c(t, o) {
    var s,
      ...
      j = z.find("[class$=-picker]"),
      D = F.find("[class$=-picker]"),
      q = T.find("[class$=-picker]");
    switch (
      (v(t.val())
        ? ((s = y(t.val())),
          (r = f(parseFloat(b(t.val())).toFixed(2), 0, 1)),
          r && t.attr("data-opacity", r))
        : (s = p(u(t.val(), !0), I.letterCase)),
      s || (s = p(m(I.defaultValue, !0), I.letterCase)),
      (a = M(s)),
      (e = I.keywords
        ? i.map(I.keywords.split(","), function (t) {
            return i.trim(t.toLowerCase());
          })
        : []),
      (c =
        "" !== t.val() && i.inArray(t.val().toLowerCase(), e) > -1
          ? p(t.val())
          : v(t.val())
            ? g(t.val())
            : s),
      ...
      I.opacity &&
        ((n =
          "" === t.attr("data-opacity")
            ? 1
            : f(parseFloat(t.attr("data-opacity")).toFixed(2), 0, 1)),
        isNaN(n) && (n = 1),
        t.attr("data-opacity", n),
        S.find("span").css("opacity", n),
        (d = f(T.height() - T.height() * n, 0, T.height())),
        q.css("top", d + "px")),
      "transparent" === t.val().toLowerCase() && S.find("span").css("opacity", 0),
      S.find("span").css("backgroundColor", s),
      I.control)
    ) {
      case "wheel":
        ((w = f(Math.ceil(0.75 * a.s), 0, z.height() / 2)),
          (C = (a.h * Math.PI) / 180),
          (h = f(75 - Math.cos(C) * w, 0, z.width())),
          (d = f(75 - Math.sin(C) * w, 0, z.height())),
          j.css({ top: d + "px", left: h + "px" }),
          (d = 150 - a.b / (100 / z.height())),
          "" === s && (d = 0),
          D.css("top", d + "px"),
          F.css("backgroundColor", k({ h: a.h, s: a.s, b: 100 })));
        break;
      case "saturation":
        ((h = f((5 * a.h) / 12, 0, 150)),
          (d = f(z.height() - Math.ceil(a.b / (100 / z.height())), 0, z.height())),
          j.css({ top: d + "px", left: h + "px" }),
          (d = f(F.height() - a.s * (F.height() / 100), 0, F.height())),
          D.css("top", d + "px"),
          F.css("backgroundColor", k({ h: a.h, s: 100, b: a.b })),
          x.find(".minicolors-grid-inner").css("opacity", a.s / 100));
        break;
      case "brightness":
        ((h = f((5 * a.h) / 12, 0, 150)),
          (d = f(z.height() - Math.ceil(a.s / (100 / z.height())), 0, z.height())),
          j.css({ top: d + "px", left: h + "px" }),
          (d = f(F.height() - a.b * (F.height() / 100), 0, F.height())),
          D.css("top", d + "px"),
          F.css("backgroundColor", k({ h: a.h, s: a.s, b: 100 })),
          x.find(".minicolors-grid-inner").css("opacity", 1 - a.b / 100));
        break;
      default:
        ((h = f(Math.ceil(a.s / (100 / z.width())), 0, z.width())),
          (d = f(z.height() - Math.ceil(a.b / (100 / z.height())), 0, z.height())),
          j.css({ top: d + "px", left: h + "px" }),
          (d = f(F.height() - a.h / (360 / F.height()), 0, F.height())),
          D.css("top", d + "px"),
  ...
  function l(i, t, o) {
    var s,
      a,
      n,
      e = i.data("minicolors-settings"),
      r = i.data("minicolors-lastChange");
    if (!r || r.value !== t || r.opacity !== o) {
      if (
        (i.data("minicolors-lastChange", { value: t, opacity: o }),
        e.swatches && 0 !== e.swatches.length)
      ) {
        for (s = v(t) ? g(t, !0) : I(t), a = -1, n = 0; n < e.swatches.length; ++n)
          if (
            s.r === e.swatches[n].r &&
            s.g === e.swatches[n].g &&
            s.b === e.swatches[n].b &&
  ...
  function h(t) {
    var o,
      s = i(t).attr("data-opacity");
    if (v(i(t).val())) o = g(i(t).val(), !0);
    else {
      var a = u(i(t).val(), !0);
      o = I(a);
    }
    return o ? (void 0 !== s && i.extend(o, { a: parseFloat(s) }), o) : null;
  }
  function d(t, o) {
    var s,
      a = i(t).attr("data-opacity");
    if (v(i(t).val())) s = g(i(t).val(), !0);
    else {
      var n = u(i(t).val(), !0);
      s = I(n);
    }
  ...
  function g(i, t) {
    var o = i.replace(/[^\d,.]/g, ""),
      s = o.split(",");
    return (
      (s[0] = f(parseInt(s[0], 10), 0, 255)),
      (s[1] = f(parseInt(s[1], 10), 0, 255)),
      (s[2] = f(parseInt(s[2], 10), 0, 255)),
      void 0 !== s[3] && (s[3] = f(parseFloat(s[3], 10), 0, 1)),
      t
        ? void 0 !== s[3]
    ...
    i.extend(i.fn, {
      minicolors: function (n, e) {
        switch (n) {
          ...
          case "opacity":
            return void 0 === e
              ? i(this).attr("data-opacity")
              : (i(this).each(function () {
                  c(i(this).attr("data-opacity", e));
                }),
                i(this));
          case "rgbObject":
            return h(i(this), "rgbaObject" === n);
          case "rgbString":
          case "rgbaString":
            return d(i(this), "rgbaString" === n);
          case "settings":
            return void 0 === e
              ? i(this).data("minicolors-settings")
              : (i(this).each(function () {
                  var t = i(this).data("minicolors-settings") || {};
                  (o(i(this)), i(this).minicolors(i.extend(!0, t, e)));
                }),
                i(this));
          case "show":
            ...
            return void 0 === e
              ...
              : (i(this).each(function () {
                  ("object" == typeof e && null !== e
                    ? (void 0 !== e.opacity && i(this).attr("data-opacity", f(e.opacity, 0, 1)),
                      e.color && i(this).val(e.color))
                    : i(this).val(e),
                    c(i(this)));
                }),
                i(this));
    ...
    i([document])
      ...
      .on("blur.minicolors", ".minicolors-input", function () {
        ...
        e.data("minicolors-initialized") &&
          ((t = r.keywords
            ? i.map(r.keywords.split(","), function (t) {
                return i.trim(t.toLowerCase());
              })
            : []),
          "" !== e.val() && i.inArray(e.val().toLowerCase(), t) > -1
            ? (n = e.val())
            : (v(e.val()) ? (s = g(e.val(), !0)) : ((o = u(e.val(), !0)), (s = o ? I(o) : null)),
              (n =
                null === s
                  ? r.defaultValue
                  : "rgb" === r.format
                    ...
                    : C(s))),
          (a = r.opacity ? e.attr("data-opacity") : 1),
          "transparent" === n.toLowerCase() && (a = 0),
          e.closest(".minicolors").find(".minicolors-input-swatch > span").css("opacity", a),
          e.val(n),
          "" === e.val() && e.val(m(r.defaultValue, !0)),
          e.val(p(e.val(), r.letterCase)));
      })
      .on("keydown.minicolors", ".minicolors-input", function (t) {
        var o = i(this);
        if (o.data("minicolors-initialized"))
          switch (t.which) {
            case 9:
              a();
              break;
