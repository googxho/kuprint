...
PrintElementOption.prototype.getLeft = function () {
  return this.left;
};
PrintElementOption.prototype.displayLeft = function () {
  return this.left + "pt";
};
PrintElementOption.prototype.setLeft = function (v) {
  if (v != null) this.left = v;
};
PrintElementOption.prototype.getTop = function () {
  return this.top;
};
PrintElementOption.prototype.getTopInDesign = function () {
  return this.topInDesign;
};
PrintElementOption.prototype.displayTop = function () {
  return this.top + "pt";
};
PrintElementOption.prototype.setTop = function (v) {
  if (v != null) this.top = v;
};
PrintElementOption.prototype.copyDesignTopFromTop = function () {
  this.topInDesign = this.top;
};
PrintElementOption.prototype.getHeight = function () {
  return this.height;
};
PrintElementOption.prototype.displayHeight = function () {
  return this.height + "pt";
};
PrintElementOption.prototype.setHeight = function (v) {
  if (v != null) this.height = v;
};
PrintElementOption.prototype.getWidth = function () {
  return this.width;
};
PrintElementOption.prototype.displayWidth = function () {
  return this.width + "pt";
};
PrintElementOption.prototype.setWidth = function (v) {
  if (v != null) this.width = v;
};
...
PrintElementOption.prototype.getPrintElementOptionEntity = function () {
  ...
  Object.keys(this)
    .filter(function (k) {
      return k !== "topInDesign";
    })
    .forEach(function (k) {
      if (
        typeof self[k] === "number" ||
        typeof self[k] === "string" ||
        typeof self[k] === "boolean"
      ) {
        entity[k] = self[k];
      }
      if (k === "style") {
...
InnerElementEditor.prototype.getDisplayHtml = function () {
  return this.title;
};
InnerElementEditor.prototype.beginEdit = function (cell) {
  ...
  $(this.editor.target).keydown(function (e) {
    if (e.keyCode === 13) self.endEdit(cell);
  });
...
TextEditor.prototype.setValue = function (v) {
  this.target.val(v);
};
